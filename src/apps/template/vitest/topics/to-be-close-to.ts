...
const Topic = (): ITopic => ({
  name: 'toBeCloseTo',
  content: [
    text('Use toBeCloseTo to compare floating-point numbers. The optional numDigits argument limits the number of digits to check after the decimal point. For example:'),
